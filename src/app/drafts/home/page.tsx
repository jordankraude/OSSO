...
import Header from "@/components/drafts/header/headerOne";
import Footer from "@/components/drafts/footer/footerOne"
  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col items-center p-6 bg-white h-96 shadow-md w-full">
        <h2 className="text-3xl font-bold mb-4 text-[#FF9999] my-auto">Get Involved</h2>
        ...
        <div className="flex space-x-4 my-auto">
          <a 
            ...
            className="bg-[#FF9999] text-white px-6 py-3 rounded-lg shadow-lg transition-transform duration-300 hover:bg-white hover:text-[#F6F051] hover:scale-105 transform-gpu"
          >
            Donor Platform
          </a>
          <a 
            href="/go" // Adjust the link to your volunteer platform route
            className="bg-[#F6F051] text-white hover:text-[#FF9999] px-6 py-3 rounded-lg shadow-lg transition-transform duration-300 hover:bg-white hover:scale-105 transform-gpu"
          >
            Volunteer Platform
          </a>
        </div>
