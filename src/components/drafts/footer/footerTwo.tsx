...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0081A7] text-white py-8 w-full">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between px-4">
        ...
        <div>
          ...
          <Link href="/501c3-paperwork">
            <button className="bg-[#0081A7] hover:bg-white hover:text-[#0081A7] text-white font-semibold py-2 px-4 rounded shadow transition duration-300">
              501(c)(3) Paperwork
            </button>
          </Link>
        </div>
